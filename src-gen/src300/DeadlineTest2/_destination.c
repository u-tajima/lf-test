...
#line 107 "/home/yu/lf-test/src300/DeadlineTest2.lf"
...
void _destination_method_record_log(void* instance_args, int64_t val, int is_miss) {
    ...
    #line 108 "/home/yu/lf-test/src300/DeadlineTest2.lf"
...
#line 34 "/home/yu/lf-test/src-gen/src300/DeadlineTest2/_destination.c"
#undef record_log
...
void _destinationreaction_function_0(void* instance_args) {
    ...
    #line 125 "/home/yu/lf-test/src300/DeadlineTest2.lf"
    (self->total_received)++;
...
#line 53 "/home/yu/lf-test/src-gen/src300/DeadlineTest2/_destination.c"
}
void _destination_deadline_function0(void* instance_args) {
    _destination_self_t* self = (_destination_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    _destination_x_t* x = self->_lf_x;
    int x_width = self->_lf_x_width; SUPPRESS_UNUSED_WARNING(x_width);
    #line 137 "/home/yu/lf-test/src300/DeadlineTest2.lf"
    (self->total_received)++;
...
#line 70 "/home/yu/lf-test/src-gen/src300/DeadlineTest2/_destination.c"
}
#undef record_log
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
...
void _destinationreaction_function_1(void* instance_args) {
    ...
    #line 150 "/home/yu/lf-test/src300/DeadlineTest2.lf"
    ...
    // 【重要】出力を確実にするためにフラッシュ
    fflush(stdout);
#line 109 "/home/yu/lf-test/src-gen/src300/DeadlineTest2/_destination.c"
}
#undef record_log
#include "include/api/reaction_macros_undef.h"
